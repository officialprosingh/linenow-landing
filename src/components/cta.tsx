    ...
    <section className="py-24 relative overflow-hidden">
      <div className="max-w-5xl mx-auto px-4 text-center">
        <div className="glass p-12 md:p-20 rounded-3xl border-ln-slate-navy relative overflow-hidden bg-gradient-to-br from-ln-slate-navy/20 to-ln-bg">
          ...
          <h2 className="text-4xl md:text-6xl font-black mb-6 text-white relative">
            Dig in today.
          </h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 relative">
            ...
            <Button
              variant="outline"
              className="w-full sm:w-auto px-10 py-4 h-auto bg-ln-slate-navy/50 text-white font-bold rounded-xl hover:bg-ln-slate-navy transition-colors border-ln-slate-navy"
            >
              Book a Demo
            </Button>
          </div>
